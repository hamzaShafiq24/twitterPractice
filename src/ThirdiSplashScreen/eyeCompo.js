    ...
    return (
        <View style={styles.mainContainer}>
            <View style={{ width: 120, height: 120, justifyContent: 'center', alignItems: 'center' }}>
                <Animated.View style={{ width: 35, height: 15, justifyContent: "center", alignItems: "center", transform: [{ translateX: vibrateTranaformInterpolated }, { scale: 0.4 }] }}>
